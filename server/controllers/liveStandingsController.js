...
const STANDINGS = {
  ...
  nb2: {
    ...
    season: '2025/26',
    standings: [
      { rank: 1,  team: { name: 'Vasas' },         all: { played: 27, win: 18, draw: 4,  lose: 5,  goals: { for: 53, against: 20 } }, goalsDiff: 33,  points: 58, form: 'WGYWW' },
      { rank: 2,  team: { name: 'Honvéd FC' },     all: { played: 27, win: 17, draw: 4,  lose: 6,  goals: { for: 45, against: 21 } }, goalsDiff: 24,  points: 55, form: 'DLWWW' },
      ...
      { rank: 4,  team: { name: 'Mezőkövesd' },    all: { played: 27, win: 12, draw: 7,  lose: 8,  goals: { for: 35, against: 31 } }, goalsDiff: 4,   points: 43, form: 'DLWLW' },
      { rank: 5,  team: { name: 'Csákvár' },       all: { played: 27, win: 10, draw: 10, lose: 7,  goals: { for: 41, against: 36 } }, goalsDiff: 5,   points: 40, form: 'LWLWW' },
      { rank: 6,  team: { name: 'Videoton' },      all: { played: 27, win: 10, draw: 9,  lose: 8,  goals: { for: 35, against: 27 } }, goalsDiff: 8,   points: 39, form: 'LWDWD' },
      { rank: 7,  team: { name: 'Kozármisleny' },  all: { played: 27, win: 10, draw: 9,  lose: 8,  goals: { for: 32, against: 37 } }, goalsDiff: -5,  points: 39, form: 'WDWWD' },
      { rank: 8,  team: { name: 'Karcag' },        all: { played: 27, win: 9,  draw: 8,  lose: 10, goals: { for: 28, against: 37 } }, goalsDiff: -9,  points: 35, form: 'DWLLL' },
      { rank: 9,  team: { name: 'BVSC-Zugló' },    all: { played: 27, win: 10, draw: 4,  lose: 13, goals: { for: 30, against: 28 } }, goalsDiff: 2,   points: 34, form: 'LWDLL' },
      { rank: 10, team: { name: 'Ajka' },          all: { played: 27, win: 10, draw: 3,  lose: 14, goals: { for: 21, against: 32 } }, goalsDiff: -11, points: 33, form: 'DDLWW' },
      { rank: 11, team: { name: 'Tiszakécske' },   all: { played: 27, win: 8,  draw: 9,  lose: 10, goals: { for: 33, against: 42 } }, goalsDiff: -9,  points: 33, form: 'LWWWD' },
      { rank: 12, team: { name: 'Szeged' },        all: { played: 27, win: 8,  draw: 8,  lose: 11, goals: { for: 26, against: 33 } }, goalsDiff: -7,  points: 32, form: 'LLDLW' },
      { rank: 13, team: { name: 'Soroksár' },      all: { played: 27, win: 6,  draw: 9,  lose: 12, goals: { for: 35, against: 43 } }, goalsDiff: -8,  points: 27, form: 'WDWLL' },
      { rank: 14, team: { name: 'Budafok' },       all: { played: 27, win: 6,  draw: 7,  lose: 14, goals: { for: 27, against: 44 } }, goalsDiff: -17, points: 25, form: 'WLLLD' },
      { rank: 15, team: { name: 'Békéscsaba' },    all: { played: 27, win: 5,  draw: 10, lose: 12, goals: { for: 25, against: 38 } }, goalsDiff: -13, points: 25, form: 'DDDLD' },
      { rank: 16, team: { name: 'Szentlőrinc' },   all: { played: 27, win: 4,  draw: 12, lose: 11, goals: { for: 30, against: 40 } }, goalsDiff: -10, points: 24, form: 'WDLLL' },
    ],
  },
  u19: {
